...
export function WhatsAppButton({ whatsappNumber, whatsappDefaultMsg }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      rel="noopener"
      aria-label="WhatsApp"
      className="fixed bottom-7 end-[100px] z-[9000] flex size-[60px] items-center justify-center rounded-full bg-[#25d366] text-white shadow-[0_6px_20px_rgba(37,211,102,0.45)] transition-all hover:scale-110 hover:shadow-[0_8px_28px_rgba(37,211,102,0.55)] dark:bg-[#1ebe5d] dark:shadow-[0_6px_20px_rgba(37,211,102,0.35)]"
    >
